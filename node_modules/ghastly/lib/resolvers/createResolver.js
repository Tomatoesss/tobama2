...
function createResolver() {
  ...
  function setDefault(option, value) {
    ...
    if (!state.defined.hasOwnProperty(option) || state.defined[option] === null || state.resolved.hasOwnProperty(option)) {
  ...
  function isRequired(option) {
    return state.required.hasOwnProperty(option) && state.required[option] !== null;
  }
  ...
  function resolve(options = {}, async = true) {
    if (!async) {
      ...
      const definedDiff = (0, _array.difference)(Object.keys(options), Object.keys(clone.defined));

      if (definedDiff.length) {
        const definedKeys = (0, _collection.sortBy)(Object.keys(clone.defined)).join('", "');
        const diffKeys = (0, _collection.sortBy)(definedDiff).join('", "');
      ...
      const requiredDiff = (0, _array.difference)(Object.keys(clone.required), Object.keys(clone.defaults));
      if (requiredDiff.length) {
        const diffKeys = (0, _collection.sortBy)(requiredDiff).join('", "');
  ...
  function get(option) {
    ...
    if (clone.allowedTypes.hasOwnProperty(option) && clone.allowedTypes[option] !== null) {
      let valid = false;
    ...
    if (clone.allowedValues.hasOwnProperty(option) && clone.allowedValues[option] !== null) {
      let success = false;
    ...
    if (clone.normalizers.hasOwnProperty(option) && clone.normalizers[option] !== null) {
